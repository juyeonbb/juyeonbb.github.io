/*
    visual
* */
const progressMainCircle = $('.main-slider-wrapper .rolling');
...
let mainSlider = new Swiper('._mainSlider', {
    ...
    navigation: {
        prevEl: '.main-slider-wrapper .btn-arrow-prev',
        nextEl: '.main-slider-wrapper .btn-arrow-next'
    },
    on: {
        autoplayTimeLeft(s, time, progress) {
            progressMainCircle.css('--progress', `calc(1 - ${progress})`);
        },
    },
});
