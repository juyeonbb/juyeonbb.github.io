...
//          noop(); // keep JSLint happy
		...
		if (data.menuicon != "") {
			if(data.menuicon == '01'){	
				//res +=  cache.tagmenuicon;	//디렉토리
				res +=  "<span class='dynatree-icon folder_m'></span>";	//디렉토리
			...
			} else if(data.menuicon == '06') { // 콘텐츠 폴더
                res +=  "<span class='dynatree-icon contents_folder'></span>"; 
            } else if(data.menuicon == '07') {  // 콘텐츠 페이지
                res +=  "<span class='dynatree-icon contents_page'></span>";
            }
...
//              this.tree.logDebug("nodeTitle: " + nodeTitle);
		...
		//직종코드 미사용 아이콘 커스텀 
		if(data.use_yn == 'N'){
			res +=  "<span class='dynatree-icon btn_close'></span>";
		}
