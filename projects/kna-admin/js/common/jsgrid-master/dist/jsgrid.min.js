...
,_sortingParams:function(){return this.sorting&&this._sortField?{sortField:this._sortField.name.split(/\.?(?=[A-Z])/).join('_').toLowerCase(),sortOrder:this._sortOrder}:{}}
